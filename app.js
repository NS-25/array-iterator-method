...
// Check your work:
//console.log('Exercise 2 my result: ', fullName);
// console.log(
...
// Complete the exercise in the space below:
const birthDate = inventors.sort((arg1, arg2) => {
...
const inventorNameAda = inventors.find((inventor) => {
...
const isEveryone19OrOlder = devs.every((person) => {
